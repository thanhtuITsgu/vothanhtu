<?php
namespace  Magenest\ReviewImport\Block\Adminhtml\Edit ;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic {
    ...
    protected function _prepareForm()
    {
        ...
        $form = $this->_formFactory->create(
            [
                'data' => [
                    'id' => 'edit_form',
                    'action' => $this->getUrl('reviewimport/index/import/'),
                    'method' => 'post',
      ...
      /*  $fieldsets['base']->addField(
            ...
            [
                ...
                'href' => $this->getUrl('reviewimport/index/index/', array('download_sample' => 'yes')),
                'label' => 'CSV Sample'
            ]
        );*/
        $fieldsets['base']->addField(
        ...
        $this->setForm($form); //Show form backend
    ...
    public function getSampleCSV(){
        return $this->appDir . 'code/Magenest/ReviewImport/sample.csv';
    }
}