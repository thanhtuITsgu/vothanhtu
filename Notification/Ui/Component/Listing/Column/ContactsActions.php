        ...
        if(isset($dataSource['data']['items'])) {
            foreach($dataSource['data']['items'] as &$item)
            {
                $item[$this->getData('name')]['edit'] = [
                    'href' => $this->urlBuilder->getUrl('notification/uiaddnotification/index',['id' => $item['entity_id']]),
                    'label' => __('Edit'),
                    'hidden' => false
                ];
                $item[$this->getData('name')]['delete'] = [
                    'href' => $this->urlBuilder->getUrl('notification/delete/delete', ['id' => $item['entity_id']]),
                    'label' => __('Delete'),
                    'hidden' => false
                ];
            }
